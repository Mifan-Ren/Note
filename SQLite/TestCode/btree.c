...
int sqlite3BtreeCursor(
  ...
  t_cursor = 0; /* has started ,just for sign */
  return SQLITE_OK;
}
...
int sqlite3BtreeInsert(
  ...
  int rc;
  testArray[t_cursor] = t_cursor;   /* set a[n] = n */
  rc = SQLITE_OK;
  return rc;
}
...
int sqlite3BtreeDelete(BtCursor *pCur, u8 flags){
 ...
 // BtShared *pBt = p->pBt;              
  int rc;                              /* Return code */
  testArray[t_cursor] = 0;  /* set a[n] = 0 for delete */
  rc = SQLITE_OK;
  return rc;
}
